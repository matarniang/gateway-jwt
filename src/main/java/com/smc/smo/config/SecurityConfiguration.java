...
import com.smc.smo.security.jwt.JWTFilter;
import com.smc.smo.security.jwt.TokenProvider;
import com.smc.smo.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/api/enable").permitAll()
            .pathMatchers("/api/verificationKey").permitAll()
