...
export class DemandeOracleService {
  ...
  protected loginDemande = this.applicationConfigService.getEndpointFor('api/demande-oracles-login', 'oracle');
  protected deleteDemande = this.applicationConfigService.getEndpointFor('api/demande-oracles-delete', 'oracle');
  ...
  getDemande(request:string): Observable<EntityResponseType> {
    return this.http
      .post<IDemandeOracle>(this.loginDemande, request, { observe: 'response' })
    ...
    deleteDemandeid(request:string): Observable<EntityResponseType> {
      return this.http
        .post<IDemandeOracle>(this.deleteDemande, request, { observe: 'response' })
        .pipe(map((res: EntityResponseType) => res));
    }
