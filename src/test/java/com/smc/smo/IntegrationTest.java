...
import com.smc.smo.GatewaySmcApp;
import com.smc.smo.ReactiveSqlTestContainerExtension;
...
@SpringBootTest(classes = { GatewaySmcApp.class, TestSecurityConfiguration.class })
